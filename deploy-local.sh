...
#   * Idempotent: re-running deploy when nothing changed is a fast no-op
#     (compose sees the image up-to-date and skips recreate unless --rebuild).
