...
import type { BacklogTasksResponse, Task, TaskCreateInput } from '@/types/backlog';
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const { project, task } = body as { project: string; task: TaskCreateInput };
    ...
    const createdTask = await getMultiBacklogStore().createTask(project, fullTask);
