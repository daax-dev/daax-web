    ...
    <div className={cn("w-full max-w-5xl mx-auto", className)}>
      ...
      <div className="mb-10">
        ...
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed text-center">
          <span className="text-cyan-400 font-semibold">Claude Flow</span> orchestrates{" "}
          <span className="text-foreground font-semibold">60+ specialized agents</span> in
          coordinated swarms. Each agent is purpose-built—coding, review, testing, security,
          documentation, DevOps—and they work together to ship complete features.
        </p>
      </div>
      ...
      <div className="p-4 rounded-xl bg-cyan-500/10 border border-cyan-500/20 mb-10 text-center">
        <p className="text-sm text-muted-foreground">
          ...
          170+ MCP tools • Multi-LLM support (Claude, GPT, Gemini, local models)
        </p>
      </div>

      {/* Swarm Patterns */}
      <h3 className="font-semibold text-foreground mb-6 text-center">Swarm Coordination Patterns</h3>
      <div className="grid md:grid-cols-2 gap-6 mb-10">
        <div className="p-6 rounded-xl bg-muted/20 border border-border/50">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h4 className="font-semibold text-foreground">Hierarchical Swarms</h4>
          </div>
          <p className="text-sm text-muted-foreground mb-3">
            A queen agent coordinates worker agents. The queen breaks down tasks, assigns work,
            reviews outputs, and handles escalations. Workers focus on their specialty.
          </p>
        ...
        <div className="p-6 rounded-xl bg-muted/20 border border-border/50">
          ...
          <p className="text-sm text-muted-foreground mb-3">
            Agents communicate peer-to-peer without central coordination. Good for exploratory
            tasks where multiple approaches should be tried in parallel.
          </p>
          <div className="text-xs text-muted-foreground font-mono bg-muted/30 p-2 rounded">
      ...
      {/* Agent Categories */}
      <h3 className="font-semibold text-foreground mb-4 text-center">60+ Specialized Agents</h3>
      <div className="flex flex-wrap justify-center gap-3 mb-10">
        ...
        <div className="p-4 rounded-xl bg-muted/20 border border-border/40 flex items-center">
          <span className="text-sm text-muted-foreground">+ 45 more agents</span>
        </div>
      </div>
      ...
      <div className="p-6 rounded-xl bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border border-cyan-500/20 mb-10">
        ...
        <p className="text-muted-foreground mb-4">
          Claude Flow remembers what works. Successful patterns—which agents to combine, what order
          to run them, how to handle specific codebases—are stored and reused. The system gets
          better at your specific workflows over time.
        </p>
        <div className="grid md:grid-cols-2 gap-4 text-sm">
          <div className="flex items-start gap-2">
            <span className="text-cyan-400">✓</span>
            <span className="text-muted-foreground">Pattern recognition across tasks</span>
          </div>
          <div className="flex items-start gap-2">
            <span className="text-cyan-400">✓</span>
            <span className="text-muted-foreground">Codebase-specific optimizations</span>
          </div>
          <div className="flex items-start gap-2">
            <span className="text-cyan-400">✓</span>
          ...
          <div className="flex items-start gap-2">
            <span className="text-cyan-400">✓</span>
            <span className="text-muted-foreground">Workflow templates from history</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="p-5 rounded-xl bg-muted/10 border border-border/40">
          ...
          <p className="text-sm text-muted-foreground">
            Initializes Claude Flow in your project with default agent configurations
            and MCP tool integrations.
          </p>
        </div>
        <div className="p-5 rounded-xl bg-muted/10 border border-border/40">
          ...
          <div className="space-y-2 text-sm">
            ...
            <p className="text-muted-foreground">
              Full documentation, agent catalog, and swarm configuration examples.
            </p>
          </div>
        </div>
      </div>
